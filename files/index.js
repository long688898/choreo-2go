...
const UUID = process.env.UUID || '986e0d08-b275-4dd3-9e75-f3094b36o82a'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || ';     
const NEZHA_PORT = process.env.NEZHA_PORT || '5555';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '';
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 't.fafa88.filegear-sg.me';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH ||'eyJhIjoiZWU4NWQ5YmQwNTI0OThhNmIwNWY0N2NjZmQ1YjM1MzIiLCJ0IjoiYzQyMDU0YjctNDdlMS00NGEwLTg4MTAtNTc4ZTJkM2FlMmEwIiwicyI6Ik9HUm1OMkU1TkdZdE1HSTNZUzAwTUdFMkxXRmhOVFF0TWpZd01tTXhZbVptWmpCbCJ9';
const CFIP = process.env.CFIP || 'ip.sb';
const NAME = process.env.NAME || 'Chr';
